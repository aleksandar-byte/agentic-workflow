...
|---|---|---|---|---|---|---|
| F1 | packages/pi-agentic-workflow/src/settings/console.ts:299-302 | code | med | fix-now | fold | no |
...
| F2 | packages/pi-agentic-workflow/src/settings/picker.ts:49-63 · :84-92 | code + api-ergonomics | med | fix-now | fold | no |
...
| F5 | packages/pi-agentic-workflow/src/settings/picker.ts:56 | api-ergonomics | med | fix-now | fold | no |
